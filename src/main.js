  ...
  return `
    <div class="command-section">
      <div class="command-header">
        <h3><i class="fa-solid fa-terminal"></i> Generated Command</h3>
...
function renderUsage() {
  ...
  return `
    <div class="usage-section">
      <details>
        <summary><i class="fa-solid fa-lightbulb"></i> Usage Guide</summary>
        <p>${usage}</p>
      </details>
    </div>
  `;
...
function updateThemeIcon() {
  ...
  if (themeIcon) {
    themeIcon.className = `fa-solid ${state.theme === 'mocha' ? 'fa-moon' : 'fa-sun'}`;
  }
}
    ...
    <div class="app-container">
      <header class="app-header">
        ...
        <button class="theme-toggle" id="themeToggle" title="Toggle theme">
          <i class="fa-solid ${state.theme === 'mocha' ? 'fa-moon' : 'fa-sun'}"></i>
        </button>
      </header>
